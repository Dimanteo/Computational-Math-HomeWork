...
int main(int argc, char **argv) {
    ...
    // Equation system
    auto func = std::make_shared<FunctionMatrix>(1, 4);
    auto jacobi = std::make_shared<FunctionMatrix>(4, 4);
    auto &f = *func.get();
    auto &j = *jacobi.get();
    // point (t, y_1 ... y_4)
    ...
    RosenbrockSolver solver(func, jacobi);
    std::ofstream ofstr;
    ...
    solver.setCoeffs();
    solveAndDump("implicit.csv", solver);
